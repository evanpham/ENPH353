...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_tests_SOURCE_PREFIX /home/pham/enph353_gym-gazebo/gym_gazebo/envs/enph353/src/ros_control/controller_manager_tests)
  set(controller_manager_tests_DEVEL_PREFIX /home/pham/enph353_gym-gazebo/gym_gazebo/envs/enph353/devel)
  ...
  set(controller_manager_tests_INSTALL_PREFIX /home/pham/enph353_gym-gazebo/gym_gazebo/envs/enph353/install)
...
if(NOT "/home/pham/enph353_gym-gazebo/gym_gazebo/envs/enph353/src/ros_control/controller_manager_tests/include " STREQUAL " ")
  set(controller_manager_tests_INCLUDE_DIRS "")
  set(_include_dirs "/home/pham/enph353_gym-gazebo/gym_gazebo/envs/enph353/src/ros_control/controller_manager_tests/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pham/enph353_gym-gazebo/gym_gazebo/envs/enph353/src/ros_control/controller_manager_tests/${idir}'.  ${_report}")
    endif()
