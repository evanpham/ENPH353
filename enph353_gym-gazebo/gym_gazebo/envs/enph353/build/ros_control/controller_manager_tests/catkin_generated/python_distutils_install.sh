...
echo_and_run cd "/home/pham/enph353_gym-gazebo/gym_gazebo/envs/enph353/src/ros_control/controller_manager_tests"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pham/enph353_gym-gazebo/gym_gazebo/envs/enph353/src/ros_control/controller_manager_tests/setup.py" \
    build --build-base "/home/pham/enph353_gym-gazebo/gym_gazebo/envs/enph353/build/ros_control/controller_manager_tests" \
    install \
    $DESTDIR_ARG \
